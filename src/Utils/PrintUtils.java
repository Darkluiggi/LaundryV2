...
public class PrintUtils {
     ...
     */
    public static void Print( List<List<String>> t2Rows, List<List<String>> t1Rows) {
        String company = ""
                + "Lavandería a Bordo\n"
        ...
        List<String> t1Headers = Arrays.asList("INFORMACIÓN", "CLIENTE");
...
//        );
        ...
        List<String> t2Headers = Arrays.asList("Género", "Nombre", "Servicio", 
                "Doblado", "Express", "Cantidad", "Subtotal");
...
//        );
        List<Integer> t2ColWidths = Arrays.asList(10, 12, 15, 8 ,8 ,8 ,8);
